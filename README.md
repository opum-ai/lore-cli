...
- Published on npm as<!--lore-version:published-bullet:begin--> **`@opum-ai/lore@0.9.3`** (bin `lore`) with six
...
> **Status:<!--lore-version:status:begin--> 0.9.3 released.** Tag `v0.9.3`, the qualified workflow artifacts,
> all seven public `@opum-ai/lore*` npm packages with `latest` moved on each,
> and a clean-registry install agree on `0.9.3`.<!--lore-version:status:end-->

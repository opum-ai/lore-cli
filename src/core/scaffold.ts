 ...
 * commented — lore uses the built-in profile (Epic/Story/Spec/ADR/Runbook/Reference/Constitution/Constants plus
...
# built-in profile (Epic/Story/Spec/ADR/Runbook/Reference/Constitution/Constants plus Attested Computation). Define your

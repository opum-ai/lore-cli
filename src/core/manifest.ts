  ...
  },
  {
    ...
    flags: [
      ...
      { name: "hermes", takesValue: false, summary: "Set up project-local Hermes context (.hermes.md)" },
      {
        name: "antigravity",
        takesValue: false,
        summary: "Set up project-local Antigravity/Gemini CLI context (GEMINI.md)",
      },
      {
        name: "tracker",
        takesValue: true,
      ...
      {
        name: "preserve-source-ids",
        takesValue: false,
        summary:
          "With --migrate-backlog: keep each task's own Backlog id instead of Quest's positional renumbering, avoiding the alias collision a dotted-subtask flattening can otherwise hit; requires --source-family",
      },
      {
        name: "source-family",
        takesValue: true,
      ...
      { name: "no-install-tracker", takesValue: false, summary: "Never install a missing tracker binary" },
      {
        name: "jira-profile",
        takesValue: true,
        summary: "jira-cli credential profile to record for --tracker jira (never a credential)",
      },
      {
        name: "jira-project",
        takesValue: true,
    ...
    examples: [
      ...
      "lore init --tracker jira --jira-profile <profile> --jira-project <KEY>",

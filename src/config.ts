 ...
 * `double` rather than rejecting it outright (true on 1.3.14, this project's pinned
 * floor). On Bun 1.4.x, `Bun.TOML.parse` itself now throws for exactly that literal
 ...
 * runtime's rejection; this branch stays for the older, still-supported one.
 */

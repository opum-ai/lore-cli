...
| [LCLI-327](../../backlog/tasks/lcli-327%20-%20docker-e2e-run-e2e.sh-writes-a-repo-local-git-identity-leaking-lore-e2e-e2elore.test-into-real-commits-on-dev.md) | docker/e2e/run-e2e.sh writes a repo-local git identity, leaking "lore e2e <e2e@lore.test>" into real commits on dev | To Do |
<!-- lore:tasks:end -->

...
repo-resident docs to [Backlog.md](https://github.com/MrLesk/Backlog.md), [Quest](https://github.com/opum-ai/quest-cli),
or Jira tasks and serves them to agents and humans through a CLI.

## Ground rules

- **lore is deliberately thin.** It does not reimplement Backlog.md, Quest, Jira, or
  Confluence, and it stays zero-config and repo-is-source-of-truth. New features should
  preserve that.
...
Tasks are tracked with [Quest](https://github.com/opum-ai/quest-cli). Run
`quest instructions overview` and `quest task list` before starting. Every Quest write needs
an explicit actor: `quest task edit <id> --actor <you> --actor-kind human ...`.

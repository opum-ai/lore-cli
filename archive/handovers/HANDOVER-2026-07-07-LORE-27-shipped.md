# Handover — LORE-27 (`lore check` drift gate) shipped, dev/main synced

**Date**: 2026-07-07 | **Grounded against**: `dev`/`main` @ `06a8063` | **Backlog**: LORE-27 Done (shipped); LORE-50 To Do, unblocked
...
- LORE-50 (Low) — the deliberately-deferred multi-root dedup cleanup flagged repeatedly
  during LORE-27's reviews (shared task ids / config validation re-resolved once per bundle
  root instead of once per run). Narrow, correctness-neutral, cleanup-grade.
- LORE-37 (Medium) — lore instructions (layered agent guides), no deps, and itself unblocks
  LORE-36 (High priority: agents SKILL.md + CLAUDE.md nudge).
...
- Prior handover `HANDOVER-2026-07-07-LORE-27-pr37-open.md` archived to `archive/handovers/` (superseded — its "review/merge PR #37" work is done).

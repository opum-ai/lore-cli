# Handover — LORE-37 (`lore instructions` — layered agent guides) shipped, dev/main synced

**Date**: 2026-07-09 | **Grounded against**: `dev`/`main` @ `1916d43` | **Backlog**: LORE-37 Done (shipped)

## Paste-ready prompt for the next session

```
FIRST run `backlog instructions overview`. LORE-37 (lore instructions -- layered
...
No Backlog item is currently in progress. LORE-36 (High priority: agents
SKILL.md + CLAUDE.md nudge) is now unblocked (its only dependency, LORE-37, is
Done) and is the natural next pick. LORE-25 (lore tasks) is also worth
considering: LORE-37's own guide content had to explicitly tell agents "there
...
- **LORE-37** → Done, shipped via PR #39; full implementation + review-fix notes (what was wrong, what was fixed, verification evidence for both passes) recorded on the task via `backlog task edit --append-notes`/`--final-summary`.

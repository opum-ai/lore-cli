...
/**
 * `CLAUDE.md` deliberately dropped (OPAG-70, 2026-09-09): it no longer carries the
 * fleet-operating block, repository profile, or portfolio-routing prose that used to state the
 * canonical slug — those moved to `@~/.claude/opum-fleet-operating.md`, outside this repository.
 * CLAUDE.md is still covered by the disk-wide stale-slug scan below (`everyDocument()`), just not
 * held to "must state the canonical slug," since it is no longer where a reader looks that up.
 */

...
5. CHANGELOG.md: add an [Unreleased] entry per the house voice, naming LCLI-261, describing the
...
6. docker/e2e/run-e2e.sh: grep for orphans assertions (phase 10, `orphans.ts`'s own TASK3 case) --
   ...
   container this wave, which is reserved for the sibling LCLI-260 worker).

...
2. Scope boundaries (deferred to owning tasks, NOT LCLI-28): validateLinks(graph) resolution + heading anchors via remark-validate-links -> LCLI-30 (check); rewriteInbound(graph) -> LCLI-35 (rename/supersede), composes normalizeLink; body-text portability scan (wikilinks/embeds/Obsidian-isms/MDX <,{) -> LCLI-30.

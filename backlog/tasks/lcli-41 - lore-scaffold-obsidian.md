...
(LCLI-28). The 5 `obsidian unresolved` entries are all links outside docs/ (../../CHANGELOG,
...
fail. tsc --noEmit clean. biome check: 4 pre-existing infos only (same as LCLI-53/54), none in

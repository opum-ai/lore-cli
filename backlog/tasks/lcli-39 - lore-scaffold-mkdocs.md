...
reconciling bundle-wide navigation that had drifted since LCLI-29).
...
5. docs/adr/index.md carried a hand-written "## Index" table duplicating the lore:index managed
   block underneath it (16 ADRs listed twice) -- same bug sibling branches LCLI-14 and LCLI-9 hit

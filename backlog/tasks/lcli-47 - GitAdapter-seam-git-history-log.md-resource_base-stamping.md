...
DOCS/TESTS: ADR-0013 LCLI-47 stamping split into its own dated amendment (was misattributed to the LCLI-46 block); lore-design §8 reworded (git is deterministic/seamed-for-impurity, not 'genuinely nondeterministic'); fixpoint test now does the real serialize(parse(x))===x round-trip; added offset-sort/file-equals-root/hash-collision/empty-root/tie-break/profile-owned-resource tests.

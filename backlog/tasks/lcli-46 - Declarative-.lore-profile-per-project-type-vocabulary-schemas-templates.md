...
- [profile]: name (req), okf_version (req; asserted vs bundle-root index.md), case (opt, default 'Title'; powers the unknown-type 'did you mean' hint, never coerces), resource_base (opt, default ''; drives lore new resource stamping per LCLI-47).
...
SCOPE BOUNDARY: resource_base is PARSED/validated/exposed here, but resource STAMPING at lore new + GitAdapter/ADR-0014 are LCLI-47, out of scope.
<!-- SECTION:PLAN:END -->

...
<!-- SECTION:PLAN:BEGIN -->
1. Import escapesRoot from ./core/rewrite into state.ts (already exported for exactly this kind of reuse per its own doc comment, precedent: commands/rename.ts's newId check, LORE-79/80).

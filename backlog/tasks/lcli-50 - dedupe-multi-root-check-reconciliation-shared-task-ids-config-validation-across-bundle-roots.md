...
lore check's status/managed-block drift pass (LCLI-27) resolves reconciliation independently per
...
This was flagged three times across LCLI-27's /code-review max rounds (1, 2, 3), each time

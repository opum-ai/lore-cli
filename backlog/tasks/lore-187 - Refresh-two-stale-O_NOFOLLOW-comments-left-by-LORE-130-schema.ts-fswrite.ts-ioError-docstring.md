...
The other O_NOFOLLOW mentions in fswrite.ts (~619/621/637/644) are deliberate historical notes in LORE-130's new docstring — leave them. No docs/ hits.

Files: src/commands/schema.ts (~115), src/commands/fswrite.ts (~419-420). Conflicts (wave scheduling) with any fswrite.ts task (LORE-120/130 done) or schema.ts task (LORE-144/167/168/182).

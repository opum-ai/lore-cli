...
assertNoSymlinkInPath (LCLI-76/77 precedent) into a new non-throwing sibling
findSymlinkSegment(root, relPath): string | null, refactored assertNoSymlinkInPath to
call it (no behavior change — confirmed the existing LCLI-76/77 message-substring tests

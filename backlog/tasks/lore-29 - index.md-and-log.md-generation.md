...
4. Portable link encoder: local encodePathSegments faithful to LORE-28's (encodeURIComponent + escape !'()*); TODO swap for links.ts import once PR #19 merges (links.ts not on dev).
...
Scope boundaries: wiring into lore sync = LORE-26; remark/AST unification of managed regions = LORE-22; encoder consolidation after #19.
<!-- SECTION:PLAN:END -->

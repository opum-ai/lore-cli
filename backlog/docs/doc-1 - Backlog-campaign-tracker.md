...
**Next issue: LORE-93** — `ensureDir` call sites in 5 commands follow
symlinks, escaping `docs/`. Item 8 of 8 — the final item in this campaign's
queue, the largest-surface item, saved for last per the user's own
risk-ascending ordering confirmed on 2026-07-21. Do not re-ask before
taking it.
...
| --- | --- | --- | --- |
| 1 | LORE-93 | bug | ensureDir call sites in 5 commands follow symlinks, escaping docs/ |

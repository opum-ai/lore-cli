...
- Ready now: LCLI-304, LCLI-306, and LCLI-307 are To Do with no formal dependencies; repository cleanliness must be confirmed before dispatch.
- In flight: none.
- Resolved in this campaign: LCLI-302, LCLI-303, and LCLI-305.
- Safest next candidate after a fresh restore: LCLI-304 by confirmed order, subject to live git, task, tool, and conflict checks. No later wave is promised.

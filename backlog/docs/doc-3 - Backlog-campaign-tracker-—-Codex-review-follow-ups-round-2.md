...
moment a conflict changes. Informational hint only: as of 2026-07-22 after **waves 1-5 merged**, **28 tasks are Done** — wave 1 (LORE-96, 98, 102, 107, 110, 114), wave 2 (LORE-97, 99, 103, 108, 111, 115), wave 3 (LORE-109, 112, 116, 122, 126), wave 4 (LORE-176 + the previously-held LORE-100 — docker-e2e CI gate green-at-birth), wave 5 (LORE-101, 104, 113, 117, 121, 123), plus 3 resolved-by-merge duplicates (LORE-127, 131 by LORE-107; LORE-173 by LORE-115). **0 held / 0 in-flight.** **56 tasks remain To Do**: the original medium queue minus the above, plus mid-campaign follow-ups still open (LORE-174, 175, 177, 178, and LORE-179 filed from wave 5). Every To Do item has **zero unmet formal deps** (re-verified live 2026-07-22 via YAML parse: the only 4 dep-bearing non-terminal tasks are the deferred LORE-42..45 in "Not queued"). Readiness is gated purely by the live pairwise file-conflict graph (same-cluster items serialize); wave membership is bounded by the 6-worker cap. Recompute the ready set live at next restore — do NOT hardcode a next-wave list.

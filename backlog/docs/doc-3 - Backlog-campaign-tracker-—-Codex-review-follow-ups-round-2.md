...
moment a conflict changes. Informational hint only: as of 2026-07-22 after **waves 1-6 merged**, **34 tasks are Done** — wave 1 (LORE-96, 98, 102, 107, 110, 114), wave 2 (LORE-97, 99, 103, 108, 111, 115), wave 3 (LORE-109, 112, 116, 122, 126), wave 4 (LORE-176 + the previously-held LORE-100 — docker-e2e CI gate green-at-birth), wave 5 (LORE-101, 104, 113, 117, 121, 123), wave 6 (LORE-105, 118, 124, 128, 132, 133), plus 3 resolved-by-merge duplicates (LORE-127, 131 by LORE-107; LORE-173 by LORE-115). **Wave 7 in flight (dispatched 2026-07-22): LORE-106, 175, 174, 177, 119, 125; 0 otherwise held.** **53 tasks remain To Do**: the original medium queue minus the above, plus mid-campaign follow-ups still open (LORE-174, 175, 177, 178, 179, and LORE-180 [medium] / 181 / 182 filed from wave 6). Every To Do item has **zero unmet formal deps** (re-verified live 2026-07-22 via YAML parse each restore: the only 4 dep-bearing non-terminal tasks are the deferred LORE-42..45 in "Not queued"). Readiness is gated purely by the live pairwise file-conflict graph (same-cluster items serialize; note the new follow-ups' conflict hints in the Queue table); wave membership is bounded by the 6-worker cap. Recompute the ready set live at next restore — do NOT hardcode a next-wave list.
...
| 11 | LORE-106 | build-runtime | — | Dispatched | 7 | Golden recorder trusts a live mutable task and an unverified upstream CLI path |
...
| 79 | LORE-174 | cmd-crud-a | — | Dispatched | 7 | lore new default title-slug path bypasses reserved index/log stem policy (wave-1 integration follow-up of LORE-114; touches src/commands/new.ts + test/new.test.ts, conflicts with LORE-115/116) |
| 80 | LORE-175 | cli-entry-state | — | Dispatched | 7 | readConfigText denied error omits errno code field (wave-2 integration follow-up of LORE-108, low; touches src/config.ts + test/config.test.ts, conflicts with LORE-108-area) |
...
| 82 | LORE-177 | cmd-link | — | Dispatched | 7 | lore link viewTask consumers don't verify returned id (sibling of LORE-122/125); filed from the wave-3 integration review. Touches src/commands/link.ts — conflicts with LORE-121. |
...
| 85 | LORE-180 | core-rewrite-engine | — | To Do | — | rewrite.ts newDestPathFor ignores leading-slash link targets, diverging from resolvePath — lore rename mis-derives /-absolute links (rot/hijack). Pre-existing; surfaced by LORE-133 (wave-6). Touches src/core/rewrite.ts — conflicts with LORE-164/165. **Medium.** |
...
| 24 | LORE-119 | cmd-crud-b | — | Dispatched | 7 | sync overwrites a status-changed doc using stale in-memory frontmatter, discarding concurrent on-disk edits |
...
| 30 | LORE-125 | cmd-meta-a | — | Dispatched | 7 | resolveRollup doesn't verify viewTask's returned id matches the requested id |

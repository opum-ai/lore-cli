...
moment a conflict changes. Informational hint only: as of 2026-07-22 after **waves 1-4 merged**, **22 tasks are Done** — wave 1 (LORE-96, 98, 102, 107, 110, 114), wave 2 (LORE-97, 99, 103, 108, 111, 115), wave 3 (LORE-109, 112, 116, 122, 126), wave 4 (LORE-176 + the previously-held LORE-100 — the docker-e2e CI gate landed green-at-birth), plus 3 resolved-by-merge duplicates (LORE-127, 131 by LORE-107; LORE-173 by LORE-115). **0 held** (LORE-100 merged in wave 4). **60 tasks remain To Do**: the original medium queue minus the above, plus mid-campaign follow-ups (LORE-174, 175 from waves 1-2; LORE-177 from wave 3; LORE-176 is now Done). Every To Do item has zero unmet formal deps (the only dep-gated item, LORE-100→LORE-176, is now merged). Actual wave membership is bounded by the 6-worker cap and the live pairwise file-conflict graph (same-cluster items serialize). Recompute the ready set live at next restore — do NOT hardcode a next-wave list.

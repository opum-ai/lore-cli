...
- bun run src/cli.ts check (the repo's own docs/ bundle, which has a real docs/log.md plus docs/{adr,reference,runbooks,specs}/index.md -- the exact fixture LORE-258 was filed against) -> "38 files, 0 errors, 0 warnings", exit 0.

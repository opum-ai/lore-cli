...
<!-- SECTION:PLAN:BEGIN -->
1. Via 'lore replace' (not hand-edit): flip cli-surface.md's obsidian bullet from (pending, LORE-41) to (shipped, LORE-41), matching mkdocs/docusaurus's phrasing.
...
3. Via 'lore replace': fix cli-contract.md's scaffold.result registry row, which said 'docusaurus/obsidian pending' — also stale for docusaurus (shipped as LORE-40) independent of this PR — to 'mkdocs, docusaurus, obsidian all shipped'.

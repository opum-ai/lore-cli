...
6. Content guardrails (grounded in src/, not the runbook): NO 'lore tasks' (unshipped LORE-25); sync.result not sync.summary; managed-block errors are validation/exit6 (no exit-4 denied); no claim that 'lore check' gates bridge drift.

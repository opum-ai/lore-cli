...
<!-- SECTION:PLAN:BEGIN -->
1. Add an explicit throw-on-duplicate contract paragraph to the MANAGED_REGION_LOCATORS JSDoc in src/core/replace.ts, naming why assertNoInjectedMarker's LORE-162 guarantee depends on it.
